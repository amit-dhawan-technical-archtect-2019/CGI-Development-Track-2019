...
declare module "@salesforce/schema/AccountChangeEvent.From_Lead__c" {
...
declare module "@salesforce/schema/AccountChangeEvent.Owner_Favorite_Color__c" {
  const Owner_Favorite_Color__c:string;
  export default Owner_Favorite_Color__c;
}
