...
declare module "@salesforce/schema/Lead.From_Lead_To_Account__c" {
  const From_Lead_To_Account__c:string;
  export default From_Lead_To_Account__c;
}
declare module "@salesforce/schema/Lead.From_Lead_To_Contact__c" {
  const From_Lead_To_Contact__c:string;
  export default From_Lead_To_Contact__c;
}
declare module "@salesforce/schema/Lead.From_Lead_To_Opportunity__c" {
