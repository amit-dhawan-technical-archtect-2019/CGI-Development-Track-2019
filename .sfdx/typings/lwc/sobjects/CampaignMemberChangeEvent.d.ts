...
declare module "@salesforce/schema/CampaignMemberChangeEvent.Number_of_Responses_Sent__c" {
  const Number_of_Responses_Sent__c:number;
  export default Number_of_Responses_Sent__c;
}
