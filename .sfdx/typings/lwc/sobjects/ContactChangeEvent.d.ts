...
declare module "@salesforce/schema/ContactChangeEvent.Default_Mailing_Address__c" {
  const Default_Mailing_Address__c:boolean;
  export default Default_Mailing_Address__c;
}
...
declare module "@salesforce/schema/ContactChangeEvent.From_Lead__c" {
  const From_Lead__c:string;
  export default From_Lead__c;
}
